...
using CustomerAPI.Infrastructure.Repository.Common;
using CustomerAPI.Infrastructure.Repository.Customer;
using CustomerAPI.Infrastructure.Repository.Login;
using CustomerAPI.Infrastructure.Repository.Product;
...
namespace CustomerAPI.Web
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IProduct, ProductRespository>();
